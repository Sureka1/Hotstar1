...
let arrayOne= [
    ...
    {
        "src": "https://img1.hotstarext.com/image/upload/f_auto,t_web_vl_3x/sources/r1/cms/prod/6184/1116184-v-14e64b70c4b6"
    }  ,
    {
...
function slideshow(){
    for(let i=0;i<slides.length;i++){
        if(currI===i){
            slides[currI].style.display="block";
        }
        else{
...
slideshow()
function slideright(){
    slides[currI+1].style.display="block";
    slides[currI].style.display="none";
    currI++;
}
function slideleft(){
    slides[currI-1].style.display="block";
